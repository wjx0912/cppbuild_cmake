...
set(PC_CURL_VERSION "7.76.1")
set(PC_CURL_INCLUDE_DIRS "D:/sdk/cmake_build/vs2019/curl-7.76.1/include")
if(CMAKE_CL_64)
    set (PC_CURL_LIBRARY_DIRS_DEBUG   "D:/sdk/cmake_build/vs2019/curl-7.76.1/_build_/x64_Dynamic/lib/Debug")
    set (PC_CURL_LIBRARY_DIRS_RELEASE "D:/sdk/cmake_build/vs2019/curl-7.76.1/_build_/x64_Dynamic/lib/Release")
else()
    set (PC_CURL_LIBRARY_DIRS_DEBUG   "D:/sdk/cmake_build/vs2019/curl-7.76.1/_build_/Win32_Dynamic/lib/Debug")
    set (PC_CURL_LIBRARY_DIRS_RELEASE "D:/sdk/cmake_build/vs2019/curl-7.76.1/_build_/Win32_Dynamic/lib/Release")
ENDIF()
...
if(NOT CURL_LIBRARY)
  ...
  find_library(CURL_LIBRARY_RELEASE NAMES
    ...
    # Windows older "Win32 - MSVC" prebuilts (libcurl.lib, e.g. libcurl-7.15.5-win32-msvc.zip):
      ...
      HINTS ${PC_CURL_LIBRARY_DIRS_RELEASE}
  )
  ...
  find_library(CURL_LIBRARY_DEBUG NAMES
    # Windows MSVC CMake builds in debug configuration on vcpkg:
      ...
      NAMES_PER_DIR
      #HINTS ${PC_CURL_LIBRARY_DIRS}
      HINTS ${PC_CURL_LIBRARY_DIRS_DEBUG}
  )
