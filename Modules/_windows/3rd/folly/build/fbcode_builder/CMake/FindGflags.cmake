...
if(CMAKE_CL_64)
    set (PC_LIBGFLAGS_INCLUDE_DIR      "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/x64_Dynamic/include/")
    set (PC_LIBGFLAGS_LIBRARY_DEBUG    "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/x64_Dynamic/lib/Debug/")
    set (PC_LIBGFLAGS_LIBRARY_RELEASE  "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/x64_Dynamic/lib/Release/")
else()
    set (PC_LIBGFLAGS_INCLUDE_DIR      "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/Win32_Dynamic/include/")
    set (PC_LIBGFLAGS_LIBRARY_DEBUG    "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/Win32_Dynamic/lib/Debug/")
    set (PC_LIBGFLAGS_LIBRARY_RELEASE  "D:/sdk/cmake_build/vs2019/gflags-2.2.2/_build_/Win32_Dynamic/lib/Release/")
ENDIF()
message("PC_LIBGFLAGS_INCLUDE_DIR: ${PC_LIBGFLAGS_INCLUDE_DIR}")
message("PC_LIBGFLAGS_LIBRARY_DEBUG: ${PC_LIBGFLAGS_LIBRARY_DEBUG}")
message("PC_LIBGFLAGS_LIBRARY_RELEASE: ${PC_LIBGFLAGS_LIBRARY_RELEASE}")
...
if (gflags_FOUND)
  ...
  FIND_PATH(LIBGFLAGS_INCLUDE_DIR gflags/gflags.h  HINTS ${PC_LIBGFLAGS_INCLUDE_DIR})

  #FIND_LIBRARY(LIBGFLAGS_LIBRARY_DEBUG NAMES gflagsd gflags_staticd  HINTS ${PC_LIBGFLAGS_LIBRARY_DEBUG})
  #FIND_LIBRARY(LIBGFLAGS_LIBRARY_RELEASE NAMES gflags gflags_static  HINTS ${PC_LIBGFLAGS_LIBRARY_RELEASE})
  FIND_LIBRARY(LIBGFLAGS_LIBRARY_DEBUG NAMES   gflags_debug  HINTS ${PC_LIBGFLAGS_LIBRARY_DEBUG})
  FIND_LIBRARY(LIBGFLAGS_LIBRARY_RELEASE NAMES gflags        HINTS ${PC_LIBGFLAGS_LIBRARY_RELEASE})
  ...
  message("debug gflags: ${gflags}")
  message("debug DEFAULT_MSG: ${DEFAULT_MSG}")
  message("debug LIBGFLAGS_LIBRARY: ${LIBGFLAGS_LIBRARY}")
  message("debug LIBGFLAGS_INCLUDE_DIR: ${LIBGFLAGS_INCLUDE_DIR}")
